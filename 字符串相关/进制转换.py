...
print("使用Python内置函数：bin()、hex()可实现int到str的进制转换")
...
print("使用formate进行格式转换")
print("10进制int转换为2进制字符串", '{:b}'.format(n))
print("10进制int转为8进制字符串", '{:o}'.format(n))
print("10进制int转换到16进制字符串", '{:x}'.format(n))
print("10进制int用Unicode解码为字符串", '{:c}'.format(n))
print("\n")

print("将16进制字符用ASCII转换为bytes", '{:x}'.format(n).encode("ascii"))
print("\n")


print("使用int()可实现str到int的进制转换")
